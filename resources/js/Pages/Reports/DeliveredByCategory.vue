    ...
    <div class="min-h-screen bg-slate-900">
        ...
        <div class="ml-64 p-8">
            <div class="mb-6 flex justify-between items-center">
                <div>
                    <h2 class="text-3xl font-bold text-white mb-2">Delivered by Category Report</h2>
                    <p class="text-slate-400">Deliveries grouped by item category</p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-slate-800 rounded-xl p-6">
                    <p class="text-slate-400 text-sm mb-1">Total Categories</p>
            ...
            <div class="bg-slate-800 rounded-xl overflow-hidden">
                <div class="p-4 border-b border-slate-700 flex justify-between items-center">
                    <h3 class="text-lg font-semibold text-white">Deliveries by Category</h3>
                    ...
                    <table class="w-full">
                        <thead class="bg-slate-700">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-medium text-slate-300 uppercase">Count</th>
                        ...
                        <tbody class="divide-y divide-slate-700">
                            <tr v-for="item in reportData" :key="item.category + item.unit" class="hover:bg-slate-700/50">
                                <td class="px-4 py-3 text-white font-medium">{{ item.category }}</td>
...
const applyFilters = () => {
    router.get('/reports/delivered-by-category', filters.value, {
        preserveState: true,
        preserveScroll: true
    });
};
...
const exportCSV = () => {
    const headers = ['Category', 'Unit', 'Count', 'Total Quantity', 'Total Amount'];
    ...
    a.href = url;
    a.download = `delivered_by_category_${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
