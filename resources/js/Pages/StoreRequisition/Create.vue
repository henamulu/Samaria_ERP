    ...
    <div class="min-h-screen bg-slate-900">
        ...
        <div class="ml-64 p-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-bold text-white">Create Store Requisition</h2>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-slate-800 rounded-xl p-6 max-w-4xl">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input v-model="form.sr_no" type="text" required readonly
                ...
                <div class="flex gap-4 mt-8">
                    <button type="submit" :disabled="processing"
                        ...
                        {{ processing ? 'Saving...' : 'Create Store Requisition' }}
                    </button>
...
const props = defineProps({
    ...
    nextSrNo: { type: String, default: 'SR1' }
});

const form = ref({
    sr_no: props.nextSrNo,
    item: '',
    item_desc: '',
    sr_quantity: '',
    unit: '',
...
const submit = () => {
    ...
    router.post('/store-requisitions', form.value, {
