...
const form = ref({
    ...
    customer: props.agreement.customer || '',
    item: props.agreement.item || '',
    unit: props.agreement.unit || 'M3',
    unit_price: props.agreement.unit_price || '',
    tax_p: props.agreement.tax_p || '',
    transport_unit: props.agreement.transport_unit || '',
    t_unit_price: props.agreement.t_unit_price || '',
...
const submit = () => {
    ...
    router.put('/customer-agreements/' + props.agreement.id, form.value, {
