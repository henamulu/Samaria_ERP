    ...
    <div class="min-h-screen bg-slate-900">
        ...
        <div class="ml-64 p-8">
            <div class="mb-6 flex justify-between items-center">
                <div>
                    <h2 class="text-3xl font-bold text-white mb-2">Edit Insurance Company</h2>
                    <p class="text-slate-400">Update insurance company information</p>
                </div>
...
onMounted(() => {
    if (props.insurance) {
        form.value = {
            ...
            branch: props.insurance.branch || '',
            contact_person: props.insurance.contact_person || '',
            phone_number: props.insurance.phone_number || '',
            insurance_status: props.insurance.insurance_status || 'Active'
        };
    }
});
...
const submitForm = () => {
    loading.value = true;
    router.put(`/insurances/${props.insurance.id}`, form.value, {
        preserveState: false,
        onFinish: () => {
            loading.value = false;
        }
