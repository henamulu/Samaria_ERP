    ...
    <div class="min-h-screen bg-slate-900">
        ...
        <div class="ml-64 p-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-bold text-white">Create Proforma Invoice</h2>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-slate-800 rounded-xl p-6 max-w-4xl">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input v-model="form.tax_p" type="number" step="0.01" value="15"
                            class="w-full bg-slate-700 border-0 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-emerald-500" />
                    </div>
                    ...
                    <div>
                        ...
                        <input v-model="form.validity" type="number" value="30"
                            class="w-full bg-slate-700 border-0 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-emerald-500" />
                    </div>
                    ...
                    <div>
                        ...
                        <input v-model="form.payment_percent" type="number" step="0.01" value="0"
                            class="w-full bg-slate-700 border-0 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-emerald-500" />
                    </div>
                ...
                <div class="flex gap-4 mt-8">
                    <button type="submit" :disabled="processing"
                        ...
                        {{ processing ? 'Saving...' : 'Create Proforma Invoice' }}
                    </button>
...
const submit = () => {
    ...
    router.post('/proforma-invoices', form.value, {
