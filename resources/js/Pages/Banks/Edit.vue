    ...
    <div class="min-h-screen bg-slate-900">
        ...
        <div class="ml-64 p-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-bold text-white">Edit Bank</h2>
            </div>
...
const form = ref({
    ...
    branch_name:      props.bank.branch_name      || '',
    bank_ac_no:       props.bank.bank_ac_no       || '',
    contact_person:   props.bank.contact_person   || '',
    bank_status:      props.bank.bank_status      || 'Active',
    have_termloan:    props.bank.have_termloan    || 'No',
    tl_amount:        props.bank.tl_amount        || 0,
    tl_interest_rate: props.bank.tl_interest_rate || 0,
    have_overdraft:   props.bank.have_overdraft   || 'No',
    od_amount:        props.bank.od_amount        || 0,
    od_interest_rate: props.bank.od_interest_rate || 0,
    od_balance:       props.bank.od_balance       || 0,
});
...
const submit = () => {
    ...
    router.put('/banks/' + props.bank.id, form.value, {
