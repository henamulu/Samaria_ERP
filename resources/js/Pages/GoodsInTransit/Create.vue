    ...
    <div class="min-h-screen bg-slate-900">
        ...
        <div class="ml-64 p-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-bold text-white">Create Goods In Transit</h2>
            </div>
            ...
            <form @submit.prevent="submit" class="bg-slate-800 rounded-xl p-6 max-w-4xl">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-slate-300 mb-2">Expected Arrival</label>
                        <input v-model="form.expected_arrival" type="date"
                            class="w-full bg-slate-700 border-0 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-emerald-500" />
                    </div>

                    <div>
                        <label class="block text-slate-300 mb-2">Origin</label>
...
const form = ref({
    git_no: '',
    git_date: new Date().toISOString().split('T')[0],
    po_id: '',
    supplier_id: '',
    customer_id: '',
    item_id: '',
...
const submit = () => {
    ...
    router.post('/goods-in-transit', form.value, {
